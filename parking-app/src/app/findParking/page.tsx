...
const getZoneInfo = (zone: number) => {
  const info = {
    1: { distance: "50m", time: "1 min", availability: 85, price: 25 },
    2: { distance: "120m", time: "2 min", availability: 65, price: 25 },
    3: { distance: "200m", time: "3 min", availability: 45, price: 25 },
    4: { distance: "300m", time: "4 min", availability: 75, price: 25 },
    5: { distance: "450m", time: "5 min", availability: 90, price: 25 },
  };
              ...
              <div className="relative">
                ...
                <div className="absolute inset-0 pointer-events-none">
                  <div className="relative w-full h-full">
                    {/* Positioning zone markers over the map */}
                    {[1, 2, 3, 4, 5].map((zone) => (
                      <Link
                        key={zone}
                        href={`/zoneDetails?zone=${zone}`}
                        className={`absolute w-10 h-10 ${getZoneColor(zone)} rounded-full flex items-center justify-center text-white font-bold shadow-lg hover:scale-110 transition-transform pointer-events-auto cursor-pointer ring-2 ring-white`}
                        style={{
                          // Position zones across the map area
                          top: zone === 1 ? '25%' : zone === 2 ? '35%' : zone === 3 ? '55%' : zone === 4 ? '75%' : '45%',
                          left: zone === 1 ? '30%' : zone === 2 ? '60%' : zone === 3 ? '45%' : zone === 4 ? '25%' : '70%'
                        }}
                      >
                        {zone}
                      </Link>
            ...
            <div className="bg-white rounded-2xl p-4 shadow-lg">
              ...
              <div className="space-y-3">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <span className="font-semibold text-blue-600">25 NOK</span>
                </div>
                <div className="flex items-center justify-between">
