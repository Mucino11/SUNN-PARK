                ...
                <div className="flex justify-between items-center">
                  <div className="flex items-center min-w-0">
                    <div
                      className={`${
                        method.type === "Vipps"
                          ? "bg-[#ff5b24]"
                          : "bg-[#e6f0fa]"
                      } rounded-full p-2.5 mr-3 flex-shrink-0`}
                    >
                      <CreditCard
                        className={`h-5 w-5 ${
                          method.type === "Vipps"
                    ...
                    <div className="min-w-0">
                      ...
                      >
                        {method.type}{" "}
                        {method.type !== "Vipps" ? `•••• ${method.last4}` : ""}
                      </div>
                      {method.type !== "Vipps" && (
                  ...
                  {method.default && (
                    <div
                      className={`${
                        method.type === "Vipps"
                          ? "bg-[#ffefe9] text-[#ff5b24]"
                          : "bg-[#c4dbf3] text-[#003087]"
                      } text-xs font-medium py-0.5 px-2 rounded-full ml-2 flex-shrink-0`}
                    >
                      Default
                    </div>
                  )}
