              ...
              <div className="relative">
                ...
                <iframe
                  ...
                  className={`transition-all duration-700 ${
                    mapLoading ? "opacity-50 scale-95" : "opacity-100 scale-100"
                  }`}
                    ...
                    >
                      <div className="flex items-center justify-between mb-3">
                        <div className="flex items-center gap-3">
                          <div
                            className={`w-12 h-12 ${getZoneColor(
                              zone
                            )} ${getZoneTextColor(
                              zone
                        ...
                        <div className="flex items-center gap-4">
                          ...
                          <div
                            className={`flex items-center gap-1 ${
                              zoneInfo.availability > 70
                                ? "text-green-600"
                                : zoneInfo.availability > 30
                                ? "text-yellow-600"
                                : "text-red-600"
                            }`}
                          >
                            ...
                            <span className="font-medium">
                              {zoneInfo.availability}% available
                            </span>
                          </div>
                        </div>
                      </div>
